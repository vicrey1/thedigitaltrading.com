...
To enable Anthropic's Claude (Haiku 4.5) for the /api/ai-chat endpoint for all clients, set one of these environment variables in your backend service:

```
ANTHROPIC_API_KEY=sk-...your-anthropic-key...
# or
CLAUDE_HAIKU_API_KEY=sk-...your-anthropic-key...
```

When present the server will use Claude Haiku 4.5 for the AI chat endpoint; if not present, the endpoint will fall back to the configured Hugging Face model.
```
