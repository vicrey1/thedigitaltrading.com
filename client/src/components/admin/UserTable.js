    ...
    <div className="bg-gray-700 rounded-lg p-4 mb-4 border border-gray-600">
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center flex-1">
          <div className="w-12 h-12 rounded-full bg-gray-600 flex items-center justify-center mr-3 flex-shrink-0">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <button 
            ...
            className="p-2 bg-gray-600 rounded-lg hover:bg-green-600 transition-colors"
      ...
      <div className="flex flex-col space-y-4 mb-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold text-white placeholder-gray-400"
            value={searchTerm}
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
          <button className="flex items-center justify-center px-4 py-2 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors">
            <FiFilter className="mr-2" /> Filters
          </button>
          <select className="bg-gray-700 rounded-lg px-4 py-2 focus:outline-none text-white">
