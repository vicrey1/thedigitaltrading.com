        ...
        <div className="space-y-4">
          ...
          <div className={`${isMobile ? 'flex flex-col gap-2' : 'flex gap-4'}`}>
            <button
              ...
              disabled={!portfolioData || !(Array.isArray(portfolioData.investments) && portfolioData.investments.some(inv => inv.status === 'active'))}
            >
            ...
            <button
              ...
              disabled={!portfolioData || !(Array.isArray(portfolioData.investments) && portfolioData.investments.some(inv => inv.status === 'completed'))}
            >
