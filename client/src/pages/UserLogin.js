...
const UserLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // Send both email and username fields, the server will handle which one is used
      ...
      <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-lg p-4 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="w-full">
            <label htmlFor="login-input" className="block text-gray-400 mb-2">Email or Username</label>
            <input
              id="login-input"
              name="login"
              type="text"
